...
// TODO: predictions; Look at generate predictions ??
// TODO: Do I want lowest cost state or the trajectory of lowest cost state?
// TODO: Should generate trajectory use spline?
vector<Vehicle> Vehicle::choose_next_state(map<int, vector<Vehicle>> predictions) {
    ...
    */
    ...
    for (vector<string>::iterator it = states.begin(); it != states.end(); ++it) {
        // Generate trajectory for each next state based on the predictions
...
vector<Vehicle> Vehicle::generate_trajectory(string state, map<int, vector<Vehicle>> predictions) {
    ...
    */
    ...
    if (state.compare("CS") == 0) {
        // TODO: Not sure if this state is needed
...
vector<Vehicle> Vehicle::constant_speed_trajectory() {
    ...
    */
    // Get s value at time t+1
    float next_pos = position_at(1);
    // Get trajectory for 2 timesteps in the future 
